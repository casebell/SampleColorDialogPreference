...
import com.cmwmobile.android.samples.R;
...
public class ColorDialogPreference extends DialogPreference {
    ...
    private static class ColorPickerView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRect(new RectF(-100, 150, 100, 200), mHSVPaint);
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                } else if ((x >= -100 & x <= 100) && (y <= 200 && y >= 150)) // see
                // if
                // we're
                // in
                // the
    ...
    public ColorDialogPreference(Context contex) {
        this(contex, null);
    }
    ...
    protected void onDialogClosed(boolean positiveResult) {
        if (positiveResult) {
        	String colorValue = Integer.toString(mCurrentColor);
            mCurrentColor = mCPView.getColor();
            SharedPreferences.Editor editor = getEditor();
            editor.putString(getKey(), colorValue);
            editor.commit();
